package com.rapples.arafat.toolbox2.backup;
...
import com.rapples.arafat.toolbox2.databinding.ActivityBarcodeComparisonBackupBinding;
...
public class BarcodeComparisonBackupActivity extends AppCompatActivity {
    ...
    private ActivityBarcodeComparisonBackupBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_barcode_comparison_backup);
    ...
    public void onSettings(View view) {
        startActivity(new Intent(BarcodeComparisonBackupActivity.this, ApplicationSettingsActivity.class));
    }
}