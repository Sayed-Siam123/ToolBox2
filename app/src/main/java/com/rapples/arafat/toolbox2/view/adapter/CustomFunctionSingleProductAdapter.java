...
public class CustomFunctionSingleProductAdapter extends RecyclerView.Adapter<CustomFunctionSingleProductAdapter.ViewHolder> {
    ...
    public CustomFunctionSingleProductAdapter(List<CustomFunctionProduct> customFunctionProductList, Context context) {
